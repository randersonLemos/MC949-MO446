...
def main(
    ...
    # -------------------------------------------------------
    # FULL IMAGE GENERATION (no refiner)
    # -------------------------------------------------------
    print("BASE stage running (final image)...")
    ...
    filename = (
        f"sdxl_lora_NOrefiner_{prompt_label}_"
...
# ======================================================================
# MAIN LOOP (same as your structure)
# ======================================================================
