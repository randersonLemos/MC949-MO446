...
def main(
    ...
    # -------------------------------------------------------
    # Load SDXL BASE + LoRA + IP-Adapter
    # -------------------------------------------------------
    print("Loading SDXL Base + LoRA + IP-Adapter...")
    ...
    base_args = dict(
        ...
        denoising_end=0.8,               # 80% base, 20% refiner
    ...
    filename = (
        f"sdxl_lora_ipadapter_refiner_{prompt_label}_"
...
# ======================================================================
# MAIN LOOP — identical structure to your reference scripts
# ======================================================================
if __name__ == '__main__':
    ...
    ROOT_FOLDER = "sdxl_lora_ip_refiner_outputs"
    ...
    # difficulty × negON/negOFF × parameter combinations
